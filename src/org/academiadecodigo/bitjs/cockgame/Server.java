...
public class Server {
    ...
    public static String checkWinner() {
        ...
        for (int i = 0; i < 9; i++) {
            if (Arrays.asList(board).contains(String.valueOf(i + 1))) {
                break;
            } else if (i == 8) return printCockDraw();
        }
    ...
    public static void printBoard() {
        ...
        boardPainter.append("\n                " + ANSI_BLUE_BACKGROUND + ANSI_BLACK + "  " + board[0] + " | " + board[1] + " | " + board[2] + "  \n" + ANSI_BLACK_BACKGROUND);
    ...
    public static String printCockWinner(){
        StringBuilder cock_winner = new StringBuilder();
        ...
        cock_winner.append("                       ,.\n" +
                ...
                "            //\n" +
                "           `\\=");
        return cock_winner.toString();
    }

    public static String printCockDraw() {
        StringBuilder cock_draw = new StringBuilder();
